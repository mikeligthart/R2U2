package edu.radboud.ai.r2u2.action;

import android.util.Log;
import edu.radboud.ai.r2u2.R2U2Controller;
import edu.radboud.ai.r2u2.action.actions.*;
import edu.radboud.ai.r2u2.action.pools.*;
import edu.radboud.ai.r2u2.action.util.*;
...
public class ActionFactory {
    ...
    private ActionFactory(R2U2Controller controller) {
        this.controller = controller;
    }

    public synchronized static ActionFactory getInstance(R2U2Controller controller) {
        if (instance == null)
