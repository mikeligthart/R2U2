...
import edu.radboud.ai.r2u2.event.Event;
import edu.radboud.ai.r2u2.event.EventHistory;
import edu.radboud.ai.r2u2.event.EventType;
 ...
 */
public class R2U2Model extends Observable {

    public static String TAG = "R2U2Model";
    ...
    private HashMap<String, R2U2User> users;

    public R2U2Model(boolean robomeConnected, boolean robomeHeadsetPluggedIn, boolean listening, float volume,
                     String _libVersion) {
        ...
        users = new HashMap<String, R2U2User>();
    ...
    public R2U2User getUser(String name) {
        return users.get(name);
    }

    public void addUser(R2U2User user) {
