package edu.radboud.ai.r2u2.senses;
...
public class AndroidMicrophone extends Observable implements ActivityResultProcessor {
    ...
    private AndroidMicrophone(R2U2Controller controller) {
        available = checkIfSpeechRecognitionIsAvailable(controller);
        this.controller = controller;
    }

    public static synchronized AndroidMicrophone getInstance(R2U2Controller controller) {
        if (instance == null)
