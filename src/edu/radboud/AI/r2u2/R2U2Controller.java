...
import edu.radboud.ai.r2u2.senses.AndroidCamera;
import edu.radboud.ai.r2u2.senses.AndroidLocation;
import edu.radboud.ai.r2u2.senses.AndroidMicrophone;
import edu.radboud.ai.r2u2.senses.SpeechEngine;
import edu.radboud.ai.r2u2.util.ActivityResultProcessor;
import edu.radboud.ai.r2u2.util.Scenario;
import edu.radboud.ai.r2u2.util.io.DataWriter;
...
public class R2U2Controller extends Activity implements Observer, RoboMe.RoboMeListener, SensorEventListener, View.OnClickListener {

    public static final String TAG = "R2U2Controller";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Classes
        model = new R2U2Model(false, robome.isHeadsetPluggedIn(), robome.isListening(),
    ...
    protected void onResume() {
        ...
        mind = R2U2Mind.getInstance(this, scenario);
    ...
    public void update(Observable observable, Object data) {
        ...
        // Model update
        else if (observable instanceof R2U2Model) {
